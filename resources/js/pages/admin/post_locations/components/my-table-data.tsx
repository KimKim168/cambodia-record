                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead onClick={() => handleSort('location_name')}>
                                <span className="flex cursor-pointer items-center">
                                    <ArrowUpDown size={16} /> {t('Location')}
                                </span>
                            </TableHead>
                            ...
                            <TableRow key={item.id}>
                                ...
                                <TableCell>
                                    <span className="flex h-full items-center justify-start">
                                        ...
                                        {hasPermission('post delete') && <DeleteButton deletePath="/admin/post_locations/" id={item.id} />}
