...
import MyAddNewButtonLocation from '@/components/my-add-new-button-location';
const AddNewButtonDiscourse = () => {
    const { t } = useTranslation();
    const [isOpen, setIsOpen] = useState(false);
    return (
        <Dialog modal={false} open={isOpen}>
            <DialogTrigger asChild>
               <MyAddNewButtonLocation
...
export default AddNewButtonDiscourse;
