...
import MyAddNewButtonNewStyleCategory from '@/components/my-add-new-button-new-style-category';
const AddNewButtonNewStylePublisher = () => {
    const { t } = useTranslation();
    const [isOpen, setIsOpen] = useState(false);
    return (
        <Dialog modal={false} open={isOpen}>
            <DialogTrigger asChild>
               <MyAddNewButtonNewStyleCategory
...
export default AddNewButtonNewStylePublisher;
