...
import MyAddNewButtonNewSubject from '@/components/my-add-new-button-new-subject';
const AddNewButtonNewSubject = () => {
    const { t } = useTranslation();
    const [isOpen, setIsOpen] = useState(false);
    return (
        <Dialog modal={false} open={isOpen}>
            <DialogTrigger asChild>
               <MyAddNewButtonNewSubject
...
export default AddNewButtonNewSubject;
