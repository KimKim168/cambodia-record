...
class PublisherController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('admin/post_publishers/Index', [
            'tableData' => $tableData,
        ]);
    }

    public function all_page_publishers()
    {
        $query = Publisher::query();
     ...
     */
    public function update(Request $request, Publisher $post_publisher)
    {
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'phone' => 'nullable|string|max:255',
        ...
        $post_publisher->update($validated);
     ...
     */
    public function update_status(Request $request, Publisher $post_publisher)
    {
        $request->validate([
            'status' => 'required|string|in:active,inactive',
        ]);
        $post_publisher->update([
    ...
    public function destroy(Publisher $post_publisher)
    {
        $post_publisher->delete();
